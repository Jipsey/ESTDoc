...
public class TechDoc
{
    ...
    public NXOpen.BlockStyler.Button button0;// Block type: Button
    public NXOpen.BlockStyler.Button button01;// Block type: Button
    ...
    public NXOpen.BlockStyler.IntegerBlock integer01;// Block type: Integer
    ...
    public NXOpen.BlockStyler.IntegerBlock integer02;// Block type: Integer
    private NXOpen.BlockStyler.Separator separator08;// Block type: Separator
    public NXOpen.BlockStyler.Button button02;// Block type: Button
    ...
    public NXOpen.BlockStyler.IntegerBlock integer021;// Block type: Integer
    private NXOpen.BlockStyler.Separator separator010;// Block type: Separator
    public NXOpen.BlockStyler.Button button03;// Block type: Button
    ...
    public NXOpen.BlockStyler.IntegerBlock integer022;// Block type: Integer
    private NXOpen.BlockStyler.Separator separator011;// Block type: Separator
    public NXOpen.BlockStyler.Button button04;// Block type: Button
    public NXOpen.BlockStyler.Button button05;// Block type: Button
//    private NXOpen.BlockStyler.Group tabPage2;// Block type: Group
//    private NXOpen.BlockStyler.Group group4;// Block type: Group
//    public NXOpen.BlockStyler.Toggle toggle03;// Block type: Toggle
//    public NXOpen.BlockStyler.Button button06;// Block type: Button
    ...
    public TechDoc()
    {
        try
        {
            ...
            //            theSession.SetUndoMark(NXOpen.Session.MarkVisibility.Visible, "Начало");
            theUI = UI.GetUI();
            ...
            theDialog.AddCloseHandler(new NXOpen.BlockStyler.BlockDialog.Close(close_cb));
        }
        catch (Exception ex)
        {
...
//            button06 = (NXOpen.BlockStyler.Button)theDialog.TopBlock.FindBlock("button06");
    ...
    public int apply_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            switch (tabControl.ActivePage)
            {
                case 0:
                    {
                        _dataService.apply_AttributeDataBinding();
                        //                    theUI.NXMessageBox.Show("Изменение атрибутов", NXMessageBox.DialogType.Information,"Изменения атрибутов успешно применено");
                        break;
                ...
                case 2:
                    {
                        _dataService.apply_AttributeDataBinding();
                        _dataService.apply_DrawingsDataBinding();
                        _dataService.apply_UploadToolsToDataBase();
                        break;
                    }
            }
        ...
        catch (Exception ex)
        {
            ...
            errorCode = 1;
            //            theUI.NXMessageBox.Show("Block Styler", NXMessageBox.DialogType.Error, ex.ToString());
            theUI.NXMessageBox.Show("Ошибка выполнения!", NXMessageBox.DialogType.Error, ex.Message);
        }
        return errorCode;
    }
...
//            }
    ...
    public void keyboardFocusNotify_cb(NXOpen.BlockStyler.UIBlock block, bool focus)
    {
        try
        {
            ...
            //            switch (tabControl.ActivePage)
            //            {
            //                case 0: _dataService.initialize_AttributeDataBinding(); break;
            //                case 1: _dataService.update_DrawingsDataBinding(); break;
            //            }
        }
        catch (Exception ex)
        {
    ...
    public bool enableOKButton_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            //            return _dataService.get_EnableApplyData();
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
